...
public final class FragmentAboutUsBinding implements ViewBinding {
  ...
  private FragmentAboutUsBinding(@NonNull FrameLayout rootView, @NonNull ImageView backToSetting) {
  ...
  public static FragmentAboutUsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAboutUsBinding((FrameLayout) rootView, backToSetting);
    }
