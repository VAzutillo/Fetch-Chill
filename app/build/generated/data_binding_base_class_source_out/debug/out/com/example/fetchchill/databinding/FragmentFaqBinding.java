...
public final class FragmentFaqBinding implements ViewBinding {
  ...
  private FragmentFaqBinding(@NonNull FrameLayout rootView, @NonNull ImageView backToSetting) {
  ...
  public static FragmentFaqBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFaqBinding((FrameLayout) rootView, backToSetting);
    }
